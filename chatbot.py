...
words = pickle.load(open('words.pkl', 'rb')) #list of pre-trained model
classes = pickle.load(open('classes.pkl', 'rb')) #list of pre-trained classes
...
window.title("Chatbot") #sets the title of window
...
window.mainloop() # Starts the main event loop of the application
